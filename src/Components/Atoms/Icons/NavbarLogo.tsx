export default function NavbarLogo(){
  return (
    <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M19.25 10.4476C16.8643 11.4065 14.6724 12.7447 12.75 14.39V12.1842C12.75 9.58506 10.6488 7.46829 8.05333 7.46829H0.75V0.929199H31.25V7.46829H20H19.25V8.21829V10.4476Z" stroke="url(#paint1_linear_1054_6329)" stroke-width="1.5" />
      <defs>
